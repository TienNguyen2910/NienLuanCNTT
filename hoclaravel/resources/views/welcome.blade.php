                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="add_kind.php" class="btn btn-primary">Thêm Loại</a>
...
<!--                                         
                                            ...
                                            while($rows=$result->fetch_assoc()){
                                                ...
                                                echo "  <td>$count</td>
                                                        <td>".$rows['tenloai']."</td>
                                                        <td><a href='edit_kind.php?idl=".$rows['maloai']."' id='nut_edit'><i class='fas fa-pencil-alt'></i>Edit</a>
                                                            <a href='del_kind.php?idl=".$rows['maloai']."' id='nut_del'><i class='fas fa-minus-circle'></i>Delete</a></td>";
                                                echo "</tr>";
                                                $count++;
                                            }
                                          -->
