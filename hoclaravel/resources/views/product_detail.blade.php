	...
	<div class="row row-1">
		...
		<div class="col-sm-6">
			...
			<div class="btn-product">
				...
				<button onclick="changeQuatity(-1)" name="minus" class=" btn btn-sub" > <i class="fas fa-minus"></i> </button>
				...
				<button onclick="changeQuatity(1)" name="plus" class=" btn btn-plus"><i class="fas fa-plus"></i></button>
	...
	<div class="row row-2">
		...
		<div class="col-md-6">
			...
			<div class="link-cart-product">
				<button id="toastbtn" onclick="myalert()" type="submit" form="form1" class="btn btn-info"><i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng</button>
