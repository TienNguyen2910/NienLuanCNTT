...
<head>
    ...
    <title>Edit Brand product</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{asset('edit-brand/'.$val->id_th)}}" method="POST" enctype="multipart/form-data">
                               {{csrf_field()}}
                                <?php 
                                ...
                                <div class="form-group row">
               						<div class="col-sm-6"><label for='tenl'>Tên danh mục</label></div>
                                    <div class="col-sm-6">
                                        <input type="text" id="tenl" required name ="name_brand" value="{{$val->ten_th}}"
                                          >
                                    </div>
                               </div>
                               <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for='ht'>Hiện thị</label>
                                    </div>
                                    <div class="col-sm-6">
                                        <select name="tt" id="ht"> 
