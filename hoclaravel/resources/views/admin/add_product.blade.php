                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{asset('store-product')}}" method="POST" enctype="multipart/form-data">
                               {{csrf_field()}}
                                <?php 
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <input type="text" id="gia" required name="price_ori"> (VNĐ)
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                       <input type="text" id="gia" required name="price"> (VNĐ)
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" required name="amount" id="sl"> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
