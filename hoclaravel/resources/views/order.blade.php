...
<body>
	<div class="container-fluid header">
		...
		<div class="row row2" style="background-color:white; ">
			<div class="col-sm">
				<a href="{{asset('/')}}" style="background-color:white; color:#d0011b;;" class="btn btn-danger" id="title"><i class="fas fa-igloo"></i>Tien Bakery 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 order-md-2 mb-4">
            ...
            @foreach($idsp as $key => $val)
              <?php 
                ...
                ->select('ten_sp','dongia_sp','soluong')->where('giohang.id_sp',$val)->get();
              ...
              <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div class="name-item">
                  ...
                  <small class="text-muted">{{number_format($res->dongia_sp)}} đ x {{$res->soluong}}</small>
                </div>
          ...
          <div class="col-md-8 order-md-1">
            ...
            <form action="{{asset('/checkout')}}" method="POST" class="needs-validation" id="formcheckout" novalidate>
              {{csrf_field()}}
              <?php
                  $id_kh = Session::get('id_client');
                  // echo "id_client = ".$id_kh; 
              ...
              ?>
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="lastName" name="fullname" value="{{$cus->ht_kh}}" required>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="email">Email</label>
                    <input type="email" class="form-control" id="email" name="email" value="{{$cus->email_kh}}" required>
                </div>

                <div class="mb-3">
                    <label for="address">Địa chỉ</label>
                    <input type="text" class="form-control" id="address" name="address"  placeholder="305c Nguyễn Văn Linh" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="phone" required name="phone" value="{{$cus->sdt_kh}}">
                </div>
                <div class="row">
                ...
                <button type="submit" class="btn btn-primary btn-lg btn-block" style="margin-bottom: 20px" >Đặt hàng</button>
              </form>
            </div>
          </div>
        </div>
